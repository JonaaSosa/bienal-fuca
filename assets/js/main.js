(function($) {
   ...
   if (countdown.length > 0) {
    countdown.each(function() {
     ...
     $countdown.countdown(finalDate, function(event) {
      $countdown.html(event.strftime('<div class="countdown-container row"><div class="col-6 col-sm-auto"><div class="countdown-item"><div class="number">%-D</div><span class="title">Day%!d</span></div></div><div class="col-6 col-sm-auto"><div class="countdown-item"><div class="number">%H</div><span class="title">Hours</span></div></div><div class="col-6 col-sm-auto"><div class="countdown-item"><div class="number">%M</div><span class="title">Minutes</span></div></div><div class="col-6 col-sm-auto"><div class="countdown-item"><div class="number">%S</div><span class="title">Seconds</span></div></div></div>'));
     });
    });
   }
  }
  ...
  function ln_slider() {
   var slider = $(".slider");
   if (slider.length > 0) {
    var count = getWindowWidth() >= 700 && getWindowHeight() >= 768 ? 6 : 2;
    var dots = getWindowWidth() >= 1024 && getWindowHeight() >= 768 ? false : true;
  ...
  var translations = {
   en: {
    ...
    "copyright": "2020 Tres51 - All rights reserved",
   },
   es: {
    "nav-inicio": "/ Inicio",
    "nav-departamentos": "Departamentos",
    "nav-contacto": "Contacto",
    "copyright": "2020 Tres51 - Todos los derechos reservados",
    "index-title": "Más de 15 años de trayectoria <br/> ofreciendo productos de alta demanda",
    "index-subtitle-1": "Tres51 es una empresa mayorista que representa, comercializa y distribuye productos de marcas nacionales e internacionales de reconocida trayectoria y respaldo, fabricados por compañías lideres de mercado.",
    "index-subtitle-2": "Abastece desde Argentina y Estados Unidos a clientes locales, de Latinoamerica y El Caribe que comprenden diversas áreas de negocios tales como el retail, las industrias y las empresas de servicios.",
    "index-subtitle-3": "Cuenta con una larga trayectoria ofreciendo productos de alta demanda para los principales mercados del continente americano, brindando todo su conocimiento y experiencia con el objetivo de construir relaciones comerciales de largo plazo basados en la transparencia y confianza.",
    "index-subtitle-4": "Como resultado de ello, ha logrado el respaldo de importantes compañías con objetivos de expansión de mercados que le han otorgado una importante diversificación de negocios.",
    "btn-nuestras-areas": "Nuestras áreas",
    "btn-ir-al-sitio": "Ir al sitio",
    "btn-enviar": "Enviar",
    "index-contactenos": "Contactenos",
    "index-contactenos-description": "Puede contactarnos vía telefónica, mail o dejarnos sus datos en el siguiente formulario. <br/> Le contestaremos a la brevedad."
   },
  };
  const langs = ["es", "en"];
  var activeLang = localStorage.getItem("lang") || window.navigator.language.substring(0, 2);
  ...
  function changeLang(lang) {
   ...
   $("[data-trans]").each(function() {
    let tag = $(this).attr("data-trans");
    $(this).html(translations[lang][tag]);
   });
  }
  //Lang swicher
  ...
  $(".navbar-toggler").on("click", function() {
   if ($(window).scrollTop() < winH) {
    $nav.toggleClass("navbar-background");
   }
  });
